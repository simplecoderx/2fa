...
if (isset($_POST["signin"])) {
  ...
  $token = md5(rand());
    ...
    $sql = "INSERT INTO users (email, password, token, status) VALUES ('$email', '$password', '$token', '0')";
    ...
    if ($result) {
      ...
      <body>
      <p><strong>Email Authentication - WEBMAPCSU</strong></p>
      <p>Hola! Verify your email to access our website. Click below link for authentication.</p>
    ...
    <div class="forms-container">
      <div class="signin-signup">
        ...
        <form action="" class="sign-up-form" method="post">
          ...
          <div class="input-field">
            <i class="fas fa-user"></i>
            <input type="text" placeholder="Full Name" name="signin_full_name" value="<?php echo $_POST["signin_full_name"]; ?>" required />
          </div>
          <div class="input-field">
            <i class="fas fa-envelope"></i>
            <input type="email" placeholder="Email Address" name="signin_email" value="<?php echo $_POST["signin_email"]; ?>" required />
          </div>
          <div class="input-field">
            <i class="fas fa-lock"></i>
            <input type="password" placeholder="Password" name="signin_password" value="<?php echo $_POST["signin_password"]; ?>" required />
          ...
          <div class="input-field">
            <i class="fas fa-lock"></i>
            <input type="password" placeholder="Confirm Password" name="signin_cpassword" value="<?php echo $_POST["signin_cpassword"]; ?>" required />
          </div>
